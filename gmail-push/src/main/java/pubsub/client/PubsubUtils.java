...
public final class PubsubUtils {
     ...
     *            A project id.
     * @param resource
     *            topic name or subscription name.
     * @return A string in a form of PROJECT_NAME/RESOURCE_NAME
     */
    public static String getFullyQualifiedResourceName(final ResourceType resourceType, final String project,
    ...
    public static Pubsub getClient() throws IOException {
        try {
            ...
            return getClient(transport, Utils.getDefaultJsonFactory());
